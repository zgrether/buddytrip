...
/**
 * Bill's own viewBox height, the divisor for the engraving's scale. His WIDTH
 * is deliberately not a constant here: nothing measures him by his bounding
 * box any more, because doing so is what put his body off the trophy's axis.
 * `BILL_INK_CX` below is the horizontal reference instead.
 */
const BILL_H = 1870;
